...
async function initializeDatabase() {
  ...
  // ── EMAIL OUTBOX (CPPM-36) ─────────────────────────────────────
  // Every outgoing transactional email is recorded here before it is sent, so a
  // restart cannot lose it, retries survive, and a final failure stays visible.
  await run(`
