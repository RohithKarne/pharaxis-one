export const SYSTEM_OPTION_SECTIONS = [
  {
    ...
    options: [
      ...
      { key: 'system_parameters', label: 'System Parameters', navValues: ['sys-system-params', 'sys-reports-access', 'sys-license-admin'] },
      { key: 'service_configurations', label: 'Service Configurations', navValues: ['sys-exception-log'] },
    ...
    options: [
      ...
      { key: 'alerts', label: 'Alerts', navValues: ['sys-setup-alerts'] },
      {
        ...
        navValues: [
          ...
          'sys-setup-int-health',
          'sys-setup-int-transmission',
        ],
      },
      { key: 'data_protection_rules', label: 'Data Protection Rules', navValues: ['sys-setup-data-protect', 'sys-setup-pdf-security'] },
      { key: 'individual_protection_rules', label: 'Individual Protection Rules', navValues: ['sys-setup-indiv-protect'] },
      {
        key: 'customized_forms',
        label: 'Customized Forms',
        navValues: [
          'sys-setup-customize-forms',
          'sys-setup-workflow',
          'sys-setup-workflow-engine',
          'sys-setup-change-approvals',
          'sys-setup-feature-flags',
          'sys-setup-smart-fields',
          'sys-setup-validation',
          'sys-setup-grid-templates',
          'sys-setup-case-actions',
          'sys-setup-compliance',
          'sys-setup-pii-redaction',
          'sys-setup-case-hyperlinks',
        ],
      },
      ...
      { key: 'email_accounts', label: 'Email Accounts', navValues: ['sys-setup-email-accounts'] },
      { key: 'developer_api', label: 'Developer API Clients', navValues: ['sys-setup-developer-api'] },
    ],
  },
  {
    key: 'security',
    ...
    options: [
      ...
      { key: 'auth_policy', label: 'Auth Policy', navValues: ['sys-sec-auth-policy'] },
