/**
 * SetupChangeApprovals.jsx — MIMS Admin > System > Setup > Change Approvals
 *
 * Wraps the existing AdminAccessSection from the legacy admin console.
 * Governance approval workflow for tracked configuration changes.
 */
...
export default function SetupChangeApprovals() {
  const { token } = useAuth()
  ...
  return (
    <div style={{ flex: 1, overflow: 'auto', padding: '20px 28px' }}>
      ...
      <AdminAccessSection contentSection="change-approvals" H={H} flash={showFlash} />
    </div>
  )
}
