 ...
 *
 * Advanced case form composition: section visibility per case type per tenant,
 * plus `field_overrides` JSON for power-user customisation. The basic section
 * Show/Hide toggle is also available in Customize Forms — this screen exposes
 * the full advanced editor.
 *
 * Wraps AdminPicklistsSection contentSection="case-form-def" from legacy admin.
 */
...
export default function SetupCaseFormDefinition() {
  ...
  return (
    <div style={{ flex: 1, overflow: 'auto', padding: '20px 28px' }}>
      ...
      <AdminPicklistsSection contentSection="case-form-def" H={H} flash={showFlash} />
    </div>
  )
}
