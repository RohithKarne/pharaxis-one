...
// GET /api/v1/agent/admin/keys — get current key config for org (masked)
...
// POST /api/v1/agent/admin/keys — save or update API key
...
// DELETE /api/v1/agent/admin/keys — remove key config
